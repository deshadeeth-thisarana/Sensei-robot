{
      "name": "Titan bot",
      "logo": "https://telegra.ph/file/9175b634560b417d4114c.jpg",
   ...
   "repository": "https://github.com/deshadeeth-thisarana/Titan-bot",
   "addons": [
      {
         "options": {
            "version": "12"
   ...
   "env": {
      ...
      "DONATION_LINK": {
         ...
         "required": false,
         "value": "https://t.me/DeshadeethThisarana"
      },
      "DEL_CMDS": {
      ...
      "BAN_STICKER": {
         ...
         "required": false,
         "value": "CAACAgIAAxkBAAFAS1xgbZYEdBBTb0GgDvSEM-Sb_aCaYAACbAADDbbSGfQdNQuRkd5EHgQ"
      },
      "WALL_API": {
